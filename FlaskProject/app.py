...
def index():
    ...
    if chart_type == "bar":
        ...
        fig = px.scatter(df, x="Year", y="Export_Value_USD", color="Country", title="Yearly Coffee Export Value")
    else:  # default to box
        fig = px.box(df, x="Region", y="Export_Value_USD", color="Country", title="Export Value by Region")
